#Python Challenge 30	Power-Ball Simulator
...
#Calculate the odds of winning this specific lot
odds = 1
for i in range(5):
...
while winning_numbers not in tickets_sold and active == True:
	...
	#Check if the user wants to continue having tickets at the indicated interval
